    ...
    <footer className="py-12 px-6 border-t border-gray-100">
      <div className="max-w-7xl mx-auto text-center space-y-8">
        <div className="flex flex-col items-center">
          <h3 className="text-xl font-bold text-secondary mb-2">Kit Tela Zero</h3>
          <p className="text-sm text-muted-foreground">© {year} Todos os direitos reservados.</p>
        </div>

        <div className="flex flex-wrap justify-center gap-6 text-sm font-semibold text-secondary/60">
