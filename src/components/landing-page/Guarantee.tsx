...
export function Guarantee() {
  return (
    <section className="py-16 px-6">
      <div className="max-w-4xl mx-auto bg-violet-50 border-2 border-violet-100 p-10 rounded-[2.5rem] flex flex-col md:flex-row items-center md:items-start space-y-6 md:space-y-0 md:space-x-10">
        <div className="flex-shrink-0 bg-white p-6 rounded-3xl shadow-sm">
          <ShieldCheck className="h-16 w-16 text-violet-500" />
        </div>
