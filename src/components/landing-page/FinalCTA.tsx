  ...
  return (
    <section className="bg-secondary py-24 px-6 text-center">
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="pt-8">
          <Button asChild size="lg" className="w-full sm:w-auto h-20 text-2xl font-black bg-primary hover:bg-primary/90 rounded-2xl px-16 shadow-[0_8px_0_0_#CC562A] active:translate-y-1 active:shadow-none transition-all">
            <a href="#precos">
