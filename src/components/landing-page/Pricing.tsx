      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div className="relative bg-white p-10 rounded-[2.5rem] border-4 border-primary shadow-2xl order-1 md:order-2 z-10">
            ...
            <Button asChild className="w-full h-20 text-xl font-black bg-primary hover:bg-primary/90 rounded-2xl shadow-[0_6px_0_0_#CC562A] active:translate-y-1 active:shadow-none transition-all">
